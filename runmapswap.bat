...
DEL /S /Q "..\Succubus Rhapsodia_mod_translated\Mod\Mod_Data\*"
...
xcopy "..\Succubus Rhapsodia_mod_translated\Data" "..\Succubus Rhapsodia Mod Translated\Mod\Mod_Data" /H /C /I /Y /E